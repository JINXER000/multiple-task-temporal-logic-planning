...
class Parser(object):
    ...
    def parse(self):
        expr = self.orx() # recursively construct syntax tree: or; and; not
        expr = expr.nnf() # transform the tree to negative normal form
...
if __name__ ==  '__main__':
    guard_expr = parse('!(a || b) && c')
    # guard_expr = parse('!a || b')
    # syntax tree: or; and; not; paranthes; or; and; not; symbol

    # NOTE: formula itself won't be transformed to nnf
